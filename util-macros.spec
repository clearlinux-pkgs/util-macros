...
Source0  : https://www.x.org/releases/individual/util/util-macros-1.19.3.tar.gz
Source1  : https://www.x.org/releases/individual/util/util-macros-1.19.3.tar.gz.sig
...
%prep
%setup -q -n util-macros-1.19.3
cd %{_builddir}/util-macros-1.19.3
pushd ..
cp -a util-macros-1.19.3 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614274982
...
cp %{_builddir}/util-macros-1.19.3/COPYING %{buildroot}/usr/share/package-licenses/util-macros/f35b1294fe252bc8ec243713fe9e214bbe5c6069
pushd ../build32/
%make_install32
